...
export class Backend implements backendInterface {
    ...
    async getURL(arg0: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getURL(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async postURL(arg0: string, arg1: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.postURL(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
